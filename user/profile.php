...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows($checkResult) > 0) {
        ...
        $updateQuery = "UPDATE studentdetail SET major='$major', phone='$phone', email='$email', degree='$degree', year='$year', skill='$skill', 10th='$sslc', 12th='$hsc', 1st='$one', 2nd='$two', 3rd='$three', 4th='$four', 5th='$five', 6th='$six' WHERE id='$idd'";
        ...
        $insertQuery = "INSERT INTO studentdetail(id, name, dno, major, phone, email, degree, year, skill, 10th, 12th, 1st, 2nd, 3rd, 4th, 5th, 6th) VALUES ('$idd','$name','$dno','$major','$phone','$email','$degree','$year','$skill','$sslc','$hsc','$one','$two','$three','$four','$five','$six')";
