        ...
        <div class="row justify-content-between">
            <div class="col">
                <a class="navbar-brand" href="https://sjctni.edu">
                    ...
                    SJC<span> Placement Management System</span>
                </a>
            </div>
        </div>
    </div>
        ...
        <tr>
            <td class="text-center">
                <div class="form-container text-center pt-2">
                    ...
                    <form action="https://formspree.io/f/xleyllyd" method="POST">
                        <div class="form-group">
                            <input type="text" class="form-control" name="Name" placeholder="Enter your Name" required>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" name="dno" placeholder="Enter your Dno" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="text-center mt-3"><a href="../home.php">Back to Home</a></div>
                    </form>
                </div>
            </td>
        </tr>
