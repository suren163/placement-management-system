...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active"><a href="recruit.html" class="nav-link">Our Recruiter</a></li>
    ...
    <body>
        <div style="text-align: center; margin-Top: 20px;">
            <img src="company.jpg" alt="Company Logos" width="1250" height="500">
        </div>
    </body>
