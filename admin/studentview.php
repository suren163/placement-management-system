                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <h2 class="card-title text-primary mb-4 text-center">Academics Information</h2>
                                        <table class="table table-bordered table-lg mx-auto">
                                            <tbody>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $s['2nd']; ?></td>
                                                </tr>
                                                <tr>
                                                    <td><strong>3rd Semester</strong></td>
                                                    <td><?php echo $s['3rd']; ?></td>
                                                </tr>
                                                <tr>
                                                    <td><strong>4th Semester</strong></td>
                                                    <td><?php echo $s['4th']; ?></td>
                                                </tr>
                                                <tr>
                                                    <td><strong>5th Semester</strong></td>
                                                    <td><?php echo $s['5th']; ?></td>
                                                </tr>
                                                <tr>
                                                    <td><strong>6th Semester</strong></td>
                                                    <td><?php echo $s['6th']; ?></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
